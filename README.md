...
Recent local evidence: standard deterministic/code tasks and short agentic decision-aid tasks mostly showed ceiling/null behavior; hypothesis: high-slop, underdetermined, high-integration, visual/gestalt work. Current non-public work keeps claim hygiene, evidence references, module validation, and non-readiness gates attached before promotion. I publish the null boundary beside the wins.
