...
The public thesis is **Metaforge = Meta + MFH + Orchestra OS**:
Meta for operating memory, MFH for evidence gates, and Orchestra for multi-agent routing that keeps work inspectable.
