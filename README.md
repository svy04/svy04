...
I do not claim Mimesis Engineering is an industry standard, statistically proven method, or universal replacement for engineering judgment.

Strong claims must point to current repository state, local runtime evidence, public primary sources, reproducible tests, external reviewer records, or explicit claim-boundary notes.
