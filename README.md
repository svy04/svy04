...
- [Mimesis Minecraft Public Redacted Board v0](https://svy04.github.io/proof-artifacts/mimesis-minecraft-public-redacted-board-v0-2026-06-15/) — public redacted board v0 / incomplete evidence board for the same local case. It exposes source-use boundary, condition board, aggregate scoring, failure record, and claim boundary, but it remains promotion-blocked. Its Promotion Blockers remain: true wrong-anchor control, public-safe per-arm screenshots, public-safe screenshots or links, fuller judge protocol, full scorer transcript, and per-arm build logs remain missing.
