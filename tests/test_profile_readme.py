...
class ProfileReadmeTests(unittest.TestCase):
    ...
    def test_current_readme_has_required_links_and_claim_boundaries(self):
        ...
        self.assertIn("wrong-anchor/conditioned arms", readme)
        ...
        self.assertIn("public redacted board is still pending", readme)
    ...
    def test_profile_verification_gate_is_documented_and_ci_wired(self):
        ...
        self.assertIn("judge protocol", proof_doc)
        self.assertIn("scorer transcript", proof_doc)
        self.assertIn("failure record", proof_doc)
        self.assertIn("public redacted board is still pending", proof_doc)
        self.assertIn("next-artifact contract, not stronger proof", proof_doc)
    ...
    def test_private_mimesis_workbench_surface_is_bounded(self):
        ...
        self.assertIn("wrong-anchor/conditioned arms", workbench)
        self.assertIn("public-safe screenshots or links", workbench)
        self.assertIn("judge protocol", workbench)
        self.assertIn("scorer transcript", workbench)
        self.assertIn("failure record", workbench)
        self.assertIn("public redacted board is still pending", workbench)
